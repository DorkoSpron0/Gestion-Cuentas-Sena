...
@Composable
fun UserLoginScreen(navController: NavController, viewModel: UserViewModel){

    val userResponse by viewModel.userLogged.collectAsState()
